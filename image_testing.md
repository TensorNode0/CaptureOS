...
- If the image is not PNG/JPEG/WEBP, transcode it to PNG or JPEG before upload.
  Fix example: if you read a .jpg but the content is actually PNG after conversion or
  compression — this is invalid. Always re-detect and update the MIME after transformations.
