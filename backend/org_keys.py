    ...
    await db.execute(
        """update org_secrets
           set anthropic_key = $2, sam_key = $3, openai_key = $4,
               emergent_key = $5, asksage_key = $6, gemini_key = $7,
               overleaf_key = $8,
        ...
        encrypted["gemini_key"], encrypted["overleaf_key"],
    ...
    fresh = await db.fetchrow(
        """update org_secrets
           set dek_wrapped = $2, anthropic_key = $3, sam_key = $4, openai_key = $5,
               emergent_key = $6, asksage_key = $7, gemini_key = $8,
               overleaf_key = $9,
               key_version = key_version + 1, updated_by = $10, updated_at = $11
           where organization_id = $1
        ...
        encrypted["asksage_key"], encrypted["gemini_key"], encrypted["overleaf_key"],
        as_uuid(rotated_by), now_utc())
